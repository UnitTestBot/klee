...
ref<Expr> Expr::createTempRead(const Array *array, Expr::Width w, unsigned off) {
  ...
  case Expr::Bool: 
    return ZExtExpr::create(ReadExpr::create(ul, 
                                             ConstantExpr::alloc(off, Expr::Int32)),
                            Expr::Bool);
  case Expr::Int8: 
  ...
  case Expr::Int16: 
    return ConcatExpr::create(ReadExpr::create(ul, 
                                               ConstantExpr::alloc(off + 1,Expr::Int32)),
                              ReadExpr::create(ul, 
                                               ConstantExpr::alloc(off,Expr::Int32)));
  case Expr::Int32: 
    return ConcatExpr::create4(ReadExpr::create(ul, 
                                                ConstantExpr::alloc(off + 3,Expr::Int32)),
                               ReadExpr::create(ul, 
                                                ConstantExpr::alloc(off + 2,Expr::Int32)),
                               ReadExpr::create(ul, 
                                                ConstantExpr::alloc(off + 1,Expr::Int32)),
                               ReadExpr::create(ul, 
                                                ConstantExpr::alloc(off,Expr::Int32)));
  case Expr::Int64: 
    return ConcatExpr::create8(ReadExpr::create(ul, 
                                                ConstantExpr::alloc(off + 7,Expr::Int32)),
                               ReadExpr::create(ul, 
                                                ConstantExpr::alloc(off + 6,Expr::Int32)),
                               ReadExpr::create(ul, 
                                                ConstantExpr::alloc(off + 5,Expr::Int32)),
                               ReadExpr::create(ul, 
                                                ConstantExpr::alloc(off + 4,Expr::Int32)),
                               ReadExpr::create(ul, 
                                                ConstantExpr::alloc(off + 3,Expr::Int32)),
                               ReadExpr::create(ul, 
                                                ConstantExpr::alloc(off + 2,Expr::Int32)),
  ...
  case Expr::Fl80: {
    ref<Expr> bytes[10];
    for (int i = 0; i < 10; ++i) {
      bytes[i] = ReadExpr::create(ul, ConstantExpr::alloc(off + 9 - i, Expr::Int32));
    }
  ...
  case Expr::Int128: {
    ref<Expr> bytes[16];
    for (int i = 0; i < 16; ++i) {
      bytes[i] = ReadExpr::create(ul, ConstantExpr::alloc(off + 15 - i, Expr::Int32));
    }
...
void Expr::printWidth(llvm::raw_ostream &os, Width width) {
  ...
  case Expr::Int128: os << "Expr::128"; break;
