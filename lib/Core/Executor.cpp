...
cl::opt<bool> StoreSeedsLocally(
    "store-seeds-locally",
    cl::desc(
        "Partialy executed states are stored locally as ktests (default=true)"),
    cl::init(false), cl::cat(SeedingCat));

cl::opt<bool> PruneAlreadyExecutedStates(
    "prune-already-executed-states",
    cl::desc(
        "Do not explore paths that have already explored seeds (default=true)"),
    cl::init(false), cl::cat(SeedingCat));
