...
public:
  ...
  explicit StoredSeed(KTest * output, unsigned steppedInstructions, bool isCompleted)
      : output(output, KTestDeleter::testKTestDeleter), steppedInstructions(steppedInstructions),
...
public:
  ...
  explicit ExecutingSeed(KTest *input, unsigned maxInstructions, bool isCompleted)
      : input(input,  KTestDeleter::testKTestDeleter), maxInstructions(maxInstructions),
