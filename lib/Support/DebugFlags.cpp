...
cl::bits<DebugPrint> debugPrints(
    ...
    cl::values(clEnumValN(DebugPrint::Forward, "forward", "Forward"),
               ...
               clEnumValN(DebugPrint::PathTree, "pathtree", "Path trees"),
               clEnumValN(DebugPrint::BlockedForward, "blockforward", ""),
               clEnumValN(DebugPrint::BlockedBackward, "blockbackward", ""),
               clEnumValN(DebugPrint::BlacklistBlockForward, "blacklistforward", ""),
               clEnumValN(DebugPrint::BlacklistBlockBackward, "blacklistbackward", "")),
    cl::CommaSeparated);
