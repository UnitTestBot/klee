...
///
/// It also provides an optional way keeping track of the various levels of
/// indentation by using a stack. \sa breakLineI() , \sa pushIndent(), \sa
/// popIndent()
class PrintContext {
private:
  llvm::raw_ostream &os;
...
public:
  ...
  void setNewline(const std::string &_newline) { newline = _newline; }
