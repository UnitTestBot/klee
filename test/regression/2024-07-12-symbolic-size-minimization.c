...
// RUN: %klee --output-dir=%t.klee-out --skip-not-lazy-initialized --use-sym-size-li --min-number-elements-li=1 --only-output-states-covering-new --allocate-determ  --skip-not-symbolic-objects --symbolic-allocation-threshold=0 %t.bc >%t.log 2>&1
